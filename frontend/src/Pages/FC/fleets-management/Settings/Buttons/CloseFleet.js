...
const CloseFleet = ({ fleetId }) => {
  ...
  return (
    <>
      <Button variant="danger" onClick={(_) => setOpen(true)}>
        Close Fleet
      </Button>
      ...
      <Modal open={open} setOpen={setOpen}>
        <Box>
          ...
          <p style={{ marginBottom: "25px" }}>
            Are you sure you want to close this fleet? All fleet members will be kicked.
          </p>

          <Buttons>
            <Button onClick={(_) => setOpen(false)}>Cancel</Button>
            <Button variant="danger" disabled={pending} tabIndex={-1} onClick={handleClick}>
              Kick all members and Close Fleet
            </Button>
          </Buttons>
        </Box>
      </Modal>
